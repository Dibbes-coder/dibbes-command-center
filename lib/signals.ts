import type { PortraitPreset, SignalDefinition, SignalType } from "./types";

export const portraitPresets: PortraitPreset[] = [
  "App Founder",
  "AI Product Face",
...
export const signals: SignalDefinition[] = [
  {
    type: "Portrait",
    eyebrow: "Identity",
    description: "Finished campaign portrait from a few raw details.",
    placeholder: "Example: founder of a calm AI finance app, warm trust, black knit, subtle phone UI...",
  },
  {
    type: "Image Prompt",
    eyebrow: "Visual",
    description: "Polished prompt first. Generate image when you want it.",
...
export function isVisualSignal(type: string): boolean {
  return type === "Portrait" || type === "Image Prompt";
}
