          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-5 max-w-2xl text-sm leading-7 text-zinc-400 sm:text-base">
                A local-first personal AI dashboard for raw signals, prompt experiments,
                active workflows, and work that is ready to ship.
              </p>
            </div>
            <div className="flex flex-wrap gap-3">
              <button className="btn-primary" onClick={createBlankItem}>Create item</button>
              <button className="btn-secondary" onClick={() => downloadItems(items)}>Export JSON</button>
              <button className="btn-secondary" onClick={restoreSamples}>Seed sample data</button>
            </div>
          </div>
        </header>
          ...
          <section className="surface rounded-[2rem] p-5 sm:p-7">
            <div className="flex flex-col gap-4 border-b border-white/10 pb-6 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <button className="btn-danger" disabled={!activeItem} onClick={deleteActiveItem}>Delete</button>
              </div>
            </div>
